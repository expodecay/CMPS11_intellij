...
/**
 * Determine the output of the following Java program. This program consists of two files: Point.java
   which defines the Point class, and PointTest.java which defines the PointTest class and contains
   function main().
 */
// Point.java
class Point{
